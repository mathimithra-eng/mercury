...
const About = () => {
  ...
  return (
    <section id="about" style={{ padding: '100px 0', background: 'rgba(255,255,255,0.02)' }} ref={sectionRef}>
      <div className="container">
        <div className="about-grid" style={{ 
          ...
          <div className="about-content">
            <h2 className="reveal-item" style={{ fontSize: '3.5rem', fontWeight: 700, marginBottom: '2rem' }}>Who We Are</h2>
            ...
            <div className="reveal-item" style={{ display: 'flex', gap: '2rem', marginTop: '3rem', flexWrap: 'wrap' }}>
              <div>
        ...
        <div style={{ marginTop: '8rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          <div className="reveal-item glass-card" style={{ padding: '2rem' }}>
            <h4 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#1a7fa0' }}>Our Vision</h4>
            <p style={{ color: '#475569' }}>To become a global leader in intelligent digital transformation—empowering industries through AI, design, and innovation.</p>
          </div>
          <div className="reveal-item glass-card" style={{ padding: '2rem' }}>
            <h4 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#1a7fa0' }}>Our Mission</h4>
            <p style={{ color: '#475569' }}>To craft future-ready experiences by blending creativity, technology, and strategy—driven by purpose, fueled by passion.</p>
          </div>
          <div className="reveal-item glass-card" style={{ padding: '2rem' }}>
            <h4 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#1a7fa0' }}>Innovation</h4>
            <p style={{ color: '#475569' }}>We constantly push boundaries, harnessing emerging technologies to shape intelligent solutions for a connected world.</p>
          </div>
        </div>
      </div>
    </section>
